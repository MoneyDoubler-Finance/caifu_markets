      ...
      _\/\\\_____________\/\\\__/\\\/////\\\__\/\\\_________\/\\\///\\\___\//\\///////______\/\\\_/\\__\////////\\\_  
       _\/\\\_____________\/\\\_\//\\\\\\\\/\\_\/\\\_________\/\\\_\///\\\__\//\\\\\\\\\\____\//\\\\\____/\\\\\\\\\\_ 
        _\///______________\///___\////////\//__\///__________\///____\///____\//////////______\/////____\//////////__                
          ...
          Example Markets — ConditionalTokens
*/
/**
...
contract ConditionalTokens is ERC1155 {
    ...
    /// Optional metadata helpers for off-chain services.
    ...
    function isConditionPrepared(bytes32 conditionId) external view returns (bool) {
        return payoutNumerators[conditionId].length > 0;
    }
    ...
    function getConditionMetadata(bytes32 conditionId) external view returns (address oracle, bytes32 questionId, uint outcomeSlotCount, uint denominator) {
        oracle = conditionOracles[conditionId];
        questionId = conditionQuestionIds[conditionId];
