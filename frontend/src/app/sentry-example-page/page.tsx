    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://caifu.sentry.io/issues/?project=4510214569590784">Issues Page</a>.
        ...
        <button
          ...
          onClick={async () => {
            await Sentry.startSpan({
              ...
              const res = await fetch(`${API_BASE}/api/sentry-example-api`);
              if (!res.ok) {
